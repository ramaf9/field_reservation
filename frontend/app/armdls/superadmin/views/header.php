		...
		<div class="topbar">
			...
			<div class="topbar-left">
				<div class="text-center">
					<a href="<?php echo base_url(''); ?>superadmin/landing" class="logo"><i class="icon-magnet icon-c-logo"></i><span>G<i class="md md-album"></i><i class="md md-album"></i>l FUTSAL</span></a>
					<!-- Image Logo here -->
